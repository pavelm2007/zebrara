...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'works_service', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['works.Service']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.parent'
        db.delete_column(u'works_service', 'parent_id')
    ...
    models = {
        ...
        u'works.service': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['works.Service']"}),
            'position': ('django.db.models.fields.SmallIntegerField', [], {'default': '100'}),
